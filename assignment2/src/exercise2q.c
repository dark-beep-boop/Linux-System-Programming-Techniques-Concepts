...
main(int argc, char **argv)
{
  ...
  /*Problem 2  : In thie Question, I have created a graph as shown in the
   * diagram below.*/
  ...
  */
  ...
  /*Now i am setting up the edges connecting two nodes of the graph using
   * function add_nbr(). Result is - Graph will be created exactly same as drawn
   * above*/
  add_nbr(A, B);
  add_nbr(A, E);
